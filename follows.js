(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'auyCtv5VzYtbHitqkSFFU8koq6Je156zhTz4UHN9lkRBLzKs', // Unique master Xively API key to be used as a default
		defaultFeeds	= [188391543], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'RisingSummer', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor =	'0A1922', // CSS HEX value of color to represent data (omit leading #)
		hideForm	1	= 0; // To hide input form use value of 1, otherwise set to 0
